...
*	- Change external reset behaviour: if reset button is pressed: start the sketch if there is one and HWB jumper is not installed (no pull-down) otherwise start bootloader
*	- Dim LED 13 in bootloader
*	
*/
